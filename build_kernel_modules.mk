...
ifeq ($(BUILDING_VENDOR_BOOT_IMAGE),true)
  ...
  BOARD_RECOVERY_KERNEL_MODULES_LOAD ?= $(RECOVERY_KERNEL_MODULES_LOAD)
endif
...
ifneq ($(TARGET_NO_KERNEL),true)
  ifeq ($(KERNEL_A32_SUPPORT), true)
    ...
    TARGET_PREBUILT_KERNEL :=$(PREBUILT_KERNEL_PATH)/gki/Image.lzma
  else
    TARGET_PREBUILT_KERNEL :=$(PREBUILT_KERNEL_PATH)/gki/Image.gz
  endif
endif

ifeq ($(TARGET_PRODUCT),$(PRODUCT_DIR)_mxl258c)
LOCAL_DTB := $(PREBUILT_KERNEL_PATH)/$(PRODUCT_DIR)_mxl258c.dtb
else ifeq ($(TARGET_PRODUCT),$(PRODUCT_DIR)_soundbar)
LOCAL_DTB := $(PREBUILT_KERNEL_PATH)/$(PRODUCT_DIR)_soundbar.dtb
else
...
include device/hardkernel/common/video_algorithm/hdr10_tmo/hdr10_tmo_modules.mk
include device/hardkernel/common/video_algorithm/frc/frc_modules.mk
include device/hardkernel/common/soft_afbc/soft_afbc_modules.mk
include device/hardkernel/common/video_algorithm/gdc/gdc_modules.mk
...
AML_VENDOR_COPY_FILES := $(PRODUCT_OUT)/vendor/lib/modules/system_dlkm.modules.load
$(AML_VENDOR_COPY_FILES): $(LOCAL_SYSTEM_PROP)
	mkdir -p $(PRODUCT_OUT)/vendor/lib/modules/
	$(transform-prebuilt-to-target)
endif
...
$(PRODUCT_OUT)/vendor.img: $(AML_VENDOR_COPY_FILES)
endif
