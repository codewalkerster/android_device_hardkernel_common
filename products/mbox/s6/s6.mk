...
#########################################################################
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,device/hardkernel/common/products/mbox/s6/files/hbg_ble/ble/b01_8.0/system/etc,vendor/etc) \
    device/hardkernel/common/products/mbox/s6/files/hbg_ble/sei/init.hbg.remote.rc:/vendor/etc/init/init.hbg.remote.rc
...
DTVKIT_HW_CONFIG_SOC := s6
ifeq ($(TUNER_MODULE),mxl258c)
DTVKIT_HW_CONFIG_SOC := s6-fccpip
endif
