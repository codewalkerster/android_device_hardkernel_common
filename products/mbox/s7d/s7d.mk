...
BOARD_AVB_KEY_PATH := $(PRODUCT_SCS_VENDOR_KEY_DIR)/fip/rsa/$(PRODUCT_SCS_PROJECT_NAME)/trustchain-0/key/bl33-level-3-rsa-priv.pem
else
BOARD_AVB_ALGORITHM := SHA256_RSA2048
BOARD_AVB_KEY_PATH := external/avb/test/data/testkey_rsa2048.pem
endif #ifeq ($(PRODUCT_USE_PREBUILD_SECURE_BOOTLOADER),true)
BOARD_AVB_ROLLBACK_INDEX := 0
BOARD_AVB_MAKE_VBMETA_IMAGE_ARGS += --prop dovi_hash:5c65b506c3a83b789b4dc7448a3ce7e3445519073e4fb55d73c90070a8431cdd
...
ifeq ($(PRODUCT_USE_PREBUILD_SECURE_BOOTLOADER),true)
BOARD_AVB_RECOVERY_KEY_PATH := $(PRODUCT_SCS_VENDOR_KEY_DIR)/fip/rsa/$(PRODUCT_SCS_PROJECT_NAME)/trustchain-0/key/bl33-level-3-rsa-priv.pem
...
#########################################################################
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,device/hardkernel/common/products/mbox/s7d/files/hbg_ble/ble/b01_8.0/system/etc,vendor/etc) \
    device/hardkernel/common/products/mbox/s7d/files/hbg_ble/sei/init.hbg.remote.rc:/vendor/etc/init/init.hbg.remote.rc
...
BOARD_VENDOR_SEPOLICY_DIRS += \
    device/hardkernel/common/products/mbox/s7d/sepolicy
