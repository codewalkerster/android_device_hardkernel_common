...
#########################################################################
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,device/hardkernel/common/products/mbox/sc2/files/hbg_ble/ble/b01_8.0/system/etc,vendor/etc) \
    device/hardkernel/common/products/mbox/sc2/files/hbg_ble/sei/init.hbg.remote.rc:/vendor/etc/init/init.hbg.remote.rc
...
DTVKIT_HW_CONFIG_SOC := sc2
ifeq ($(TUNER_MODULE),mxl258c)
DTVKIT_HW_CONFIG_SOC := sc2-fccpip
endif
...
BOARD_VENDOR_SEPOLICY_DIRS += \
    device/hardkernel/common/products/mbox/sc2/sepolicy
