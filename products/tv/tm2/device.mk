...
#########################################################################
PRODUCT_COPY_FILES += \
    device/amlogic/common/products/tv/tm2/files/media_profiles.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles.xml \
    device/amlogic/common/products/tv/tm2/files/media_profiles_V1_0.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml



# tv config file
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,device/amlogic/common/products/tv/tm2/files/tv/tvconfig/,/$(TARGET_COPY_OUT_ODM)/etc/tvconfig) \
    device/amlogic/common/products/tv/tm2/files/tv/dec:$(TARGET_COPY_OUT_ODM)/bin/dec \
    device/amlogic/common/products/tv/tm2/files/PQ/pq.db:$(TARGET_COPY_OUT_ODM)/etc/tvconfig/pq/pq.db \
