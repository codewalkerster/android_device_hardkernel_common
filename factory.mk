...
$(INSTALLED_AMLOGIC_BOOTLOADER_TARGET) : $(word 1,$(BOOTLOADER_INPUT)) $(INSTALLED_AML_GPT)
	...
	cp $(TARGET_DEVICE_DIR)/bootloader_unsign.img $(PRODUCT_OUT)/upgrade/bootloader.img
...
INSTALLED_DEBUG_FIRST_STAGE := $(PRODUCT_OUT)/debug_ramdisk/first_stage_ramdisk/adb_debug.prop
$(INSTALLED_DEBUG_FIRST_STAGE) : $(PRODUCT_OUT)/ramdisk.img $(PRODUCT_OUT)/debug_ramdisk/userdebug_plat_sepolicy.cil
	touch $(PRODUCT_OUT)/debug_ramdisk/first_stage_ramdisk/force_debuggable
	cp -a $(PRODUCT_OUT)/debug_ramdisk/adb_debug.prop $(PRODUCT_OUT)/debug_ramdisk/first_stage_ramdisk/
	cp -a $(PRODUCT_OUT)/debug_ramdisk/userdebug_plat_sepolicy.cil $(PRODUCT_OUT)/debug_ramdisk/first_stage_ramdisk/

$(PRODUCT_OUT)/ramdisk-debug.img: $(INSTALLED_DEBUG_FIRST_STAGE)
...
ifeq ($(BOARD_USES_VENDOR_DLKMIMAGE),true)
FASTBOOT_IMAGES += vendor_dlkm.img
endif
