...
def main(argv):
    ...
    load_dtb = ''
    try:
        opts, args = getopt.getopt(argv, "h", ["input=","input_dtb_subscript=","input_ini_subscript=","variant=","boot-part=","recovery-part=","wifi-country=","output=","mtd=","target-dtb=","target-board=","emmc-boot-device=","sd-boot-device="])
    ...
    line = template_in_t.substitute(_variant=variant,_boot_part=boot_part,_recovery_part=recovery_part,_wifi_country=wifi_country, _load_dtb=load_dtb, _load_ini=load_ini, _mtd=mtd, _emmc_boot_device=emmc_boot_device, _sd_boot_device=sd_boot_device)
