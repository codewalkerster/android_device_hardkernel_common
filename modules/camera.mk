...
DEVICE_MANIFEST_FILE += device/hardkernel/common/manifests/android.hardware.camera.provider@2.4-provider.virtual.xml
endif
...
DEVICE_MANIFEST_FILE += device/hardkernel/common/manifests/android.hardware.camera.provider@2.4-provider.external-virtual.xml
...
PRODUCT_COPY_FILES += \
	device/hardkernel/common/1920x1080.yuv:$(TARGET_COPY_OUT_VENDOR)/etc/camera/1920x1080.yuv
endif
