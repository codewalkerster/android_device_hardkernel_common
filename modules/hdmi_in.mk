...
# Add manifest
DEVICE_FRAMEWORK_COMPATIBILITY_MATRIX_FILE += device/hardkernel/common/manifests/frameworks/rockchip.hardware.tv.input@1.0-service.xml
DEVICE_MANIFEST_FILE += device/hardkernel/common/manifests/android.hardware.tv.input@1.0-service.xml
