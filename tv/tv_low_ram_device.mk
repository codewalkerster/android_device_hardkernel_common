...
PRODUCT_COPY_FILES += \
    ...
    device/hardkernel/common/tv/init.enableswap.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.enableswap.rc \
    device/hardkernel/common/tv/fstab.enableswap:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.enableswap
