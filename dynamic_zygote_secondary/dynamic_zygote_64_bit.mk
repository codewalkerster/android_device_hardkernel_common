...
PRODUCT_COPY_FILES += \
    device/amlogic/common/dynamic_zygote_secondary/init.zygote64_32.rc:root/init.zygote64_32.rc
else
PRODUCT_COPY_FILES += \
    device/amlogic/common/dynamic_zygote_secondary/init.zygote64_32.rc:recovery/root/init.zygote64_32.rc
endif
